...
extern void *mono_aot_module_StopWatch_info;
...
extern void *mono_aot_module_RSKImageCropper_info;

void xamarin_register_modules_impl ()
{
	mono_aot_register_module (mono_aot_module_StopWatch_info);
	...
	mono_aot_register_module (mono_aot_module_RSKImageCropper_info);
...
void xamarin_register_assemblies_impl ()
{
	...
	xamarin_open_and_register ("RSKImageCropper.dll", &exception_gchandle);
	xamarin_process_managed_exception_gchandle (exception_gchandle);
